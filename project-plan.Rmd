...
For transparency s sake, its also important to note how many films under each genre make up the dataset
```{r}
...
ggplot(genre_total) + geom_bar(mapping = aes(genre, sumG), stat = "identity")
