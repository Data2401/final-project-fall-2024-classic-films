...
#ggplot(raw_data, aes(x = Year, y = count_movieby_year)) + geom_col()
...
#raw_data |> group_by(Year)|> summarise(InfatedBudget = n()) |> ggplot(aes(year,InflatedBudget)) +geom_point() + geom_smooth()
```
## Questions
