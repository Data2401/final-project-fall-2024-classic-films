...
Is there a specific genre that costs more to produce? First, we'll see what the most and least expensive films where.

```{r}
#summarise (max(raw_data$InflatedBudget)
```
